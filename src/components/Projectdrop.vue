    ...
    <div class="mx-2 mb-2">
        ...
        <div v-if="isOpen" class="my-2 p-2 bg-gray-100 rounded-lg shadow-lg border border-teal-400 sm:grid-cols-2">
            <div class="m-2 p-2">
                ...
                <p class="mx-2">
                    <span class="badge sm:mr-1 bg-orange-500">HTML</span>
                    <span class="badge sm:mr-1 bg-blue-500">CSS</span>
                    <span class="badge sm:mr-1 bg-yellow-500">Javascript</span>
                    <span class="badge sm:mr-1 bg-purple-600">Bootstrap</span></p>
            ...
            <div class="m-2 p-2">
                ...
                <p class="mx-2 align-baseline">
                    <span class="badge sm:mr-1 bg-blue-600">Python</span>
                    <span class="badge sm:mr-1 bg-green-500">Shell</span>
                    <span class="badge sm:mr-1 bg-gray-600">Selenium</span></p>
            ...
            <div class="m-2 p-2">
                ...
                <p class="mx-2 align-baseline">
                    <span class="badge sm:mr-1 bg-yellow-800">Java</span>
