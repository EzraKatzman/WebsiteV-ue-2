    ...
    <div>
        <footer class="sticky bg-gradient-to-r from-orange-300 to-orange-400 sm:flex sm:justify-between sm:items-center text-white text-center sm:px-4 sm:py-3 border-t-2 border-orange-300">
            <p class="text-xl xl:text-2xl m-1">
                ...
                <a href="" target="_blank"><svg viewBox="0 0 448 512" fill="currentColor" class="inline w-5 h-5 hover:text-gray-900">
                    <path d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"/></svg></a>
                <a href="https://github.com/EzraKatzman" target="_blank"><svg viewBox="0 0 24 24" fill="currentColor" class="inline w-5 h-5 hover:text-gray-900">
                ...
                <a href="mailto:ezkatzman@gmail.com"><svg viewBox="0 0 20 20" fill="currentColor" class="inline w-5 h-5 hover:text-gray-900">
                ...
                <a href="https://github.com/EzraKatzman/My-Website" target="_blank"><svg viewBox="0 0 20 20" fill="currentColor" class="inline w-5 h-5 hover:text-gray-900">
