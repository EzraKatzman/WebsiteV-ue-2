<template>
    <header class="bg-gradient-to-l from-teal-300 to-teal-500 sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-3 border-t-2 border-b-2 border-teal-300">
